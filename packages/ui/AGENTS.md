...
Session/ChatRun/Operation 与 Agent 可见状态的项目级 proposed SPEC 见 `../../spec/session/`、`../../spec/agent/`；全局 UI 交互、设计系统和无障碍规则见 `../../spec/ui/`；UI store 只做 projection，不拥有 CP durable lifecycle。
